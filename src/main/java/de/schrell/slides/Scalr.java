...
public class Scalr {
	...
	public static BufferedImage apply(BufferedImage src, final BufferedImageOp... ops)
		...
		for (final BufferedImageOp op : ops) {
			 ...
			 */
			final BufferedImage dest = createOptimalImage(src,
	...
	protected static BufferedImage copyToOptimalImage(final BufferedImage src)
		...
		final int type = (src.getTransparency() == Transparency.OPAQUE ? BufferedImage.TYPE_INT_RGB
			: BufferedImage.TYPE_INT_ARGB);
		final BufferedImage result = new BufferedImage(src.getWidth(),
			src.getHeight(), type);
	 ...
	 *             operations.
	 */
	public static BufferedImage crop(final BufferedImage src, final int width, final int height,
	 ...
	 *             operations.
	 */
	public static BufferedImage crop(final BufferedImage src, final int x, final int y,
	 ...
	 *             operations.
	 */
	public static BufferedImage resize(final BufferedImage src, final int targetWidth,
	 ...
	 * @see Method
	 */
	public static BufferedImage resize(final BufferedImage src, final Method scalingMethod,
	 ...
	 * @see Mode
	 */
	public static BufferedImage resize(final BufferedImage src, Method scalingMethod,
		final Mode resizeMode, int targetWidth, int targetHeight,
		final BufferedImageOp... ops) throws IllegalArgumentException,
	ImagingOpException {
		long t = -1;
		if (DEBUG) {
	 ...
	 * @see Mode
	 */
	public static BufferedImage resize(final BufferedImage src, final Mode resizeMode,
		final int targetSize, final BufferedImageOp... ops)
			throws IllegalArgumentException, ImagingOpException {
	 ...
	 * @see Rotation
	 */
	public static BufferedImage rotate(final BufferedImage src, final Rotation rotation,
		final BufferedImageOp... ops) throws IllegalArgumentException,
	ImagingOpException {
		long t = -1;
		if (DEBUG) {
	...
	protected static BufferedImage scaleImage(final BufferedImage src,
		final int targetWidth, final int targetHeight, final Object interpolationHintValue) {
		// Setup the rendering resources to match the source image's
		final BufferedImage result = createOptimalImage(src, targetWidth,
			targetHeight);
	...
	protected static BufferedImage scaleImageIncrementally(BufferedImage src,
		final int targetWidth, final int targetHeight, final Method scalingMethod,
		...
		do {
			...
			final BufferedImage incrementalImage = scaleImage(src, currentWidth,
